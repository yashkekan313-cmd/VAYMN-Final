  ...
  try {
    ...
    return {
      text:
        ...
        "I'm ready to help you find your next book. What are you looking for?",
      links: [],
    };
  } catch (error) {
    ...
    return {
      text:
        "I'm currently performing an inventory check. Please ask me about a specific title in a moment.",
    };
  }
};
...
export const getBookInsight = async (title: string, author: string) => {
  try {
    ...
    return (
      (response as any).text ||
      "A fascinating addition to our library collection."
    );
  } catch (e) {
